...
st.set_page_config(page_title="Singapore Resale Flat Prices Predicting | By Karthik ",
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Karthik*!
...
def load_data():
    # Load data
    data = pd.read_csv('D:/program session/project/Singapore resales/new.csv')
...
def train_model(data):
    ...
    y = data['resale_price']
    trained_model = RandomForestRegressor(random_state=72)
...
if selected == "Predict":
    def main():
        ...
        remaining_lease_ = st.sidebar.text_input("Enter the remaining lease duration (years-months e.g., '63-7')")
...
if selected == "Contact":
    ...
    with col2:
        ...
        st.markdown("### :blue[Technologies :] Python, Pandas, Numpy, Scikit-Learn, Streamlit, Python scripting, "
                    ...
                    "Model Deployment")
        st.markdown("### :blue[Overview :] This prediction model will be based on past transactions "
